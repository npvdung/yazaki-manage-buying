...
namespace Base_Asp_Core_MVC_with_Identity.Controllers
{
    ...
    public class AccountUserApiController : ControllerBase
    {
        ...
        public AccountUserApiController(Base_Asp_Core_MVC_with_IdentityContext context, UserManager<UserSystemIdentity> uid, UserManager<UserSystemIdentity> usrMgr)
        {
            _uid = uid;
            _context = context;
            _userManager = usrMgr;
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                int recordsTotal = 0;
                var customerData = from tempcustomer in _userManager.Users select tempcustomer;
