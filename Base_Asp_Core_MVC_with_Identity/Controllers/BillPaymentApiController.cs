    ...
    public class BillPaymentApiController : ControllerBase
    {
        ...
        public IActionResult Index()
        {
            try
            {
                ...
                var customerData = from tempcustomer in _context.BillPayment
                                   join temp1 in _context.ItemReceipt on tempcustomer.ItemReceiptId equals temp1.ID.ToString() into tempTable
                ...
                {
                    customerData = customerData.Where(m => m.BillPaymentCode.Contains(searchValue));
                }
