    ...
    columns: [
      { data: "id", name: "Id", autoWidth: true },
      {
        ...
        render: function (data, type, row) {
          ...
          return `<a href="/IngredientsGroup/Edit/${Id}" m-1">Xem | Sửa</a>`;
        },
      },
      {
        data: null,
      ...
      {
        data: "ingredientsGroupCode",
        name: "ingredientsGroupCode",
        autoWidth: true,
      },
      {
        data: "ingredientsGroupName",
        name: "ingredientsGroupName",
        autoWidth: true,
      },
      {
        data: "status",
